...
class TrainConfig:
    ...
    raw_data_path: Path = "data/ssw_esd"
    val_ids_path: Path = "data/val_ids.txt"
    ...
    # Vocoder
    vocoder_checkpoint_path: str = "data/g_01800000"
    ...
    phones_mapping_path: Path = Path("data/preprocessed/phones.json")
    ...
    lightning_checkpoint_path: str = "data/checkpoint" # directory to save checkpoints
    train_from_checkpoint: Optional[str] = None # filename in <lightning_checkpoint_path> directory
    num_workers: int = 1
    test_wav_files_directory: str = "data/wav"
    test_mos_files_directory: str = "data/mos"
    ...
    # Test / Inference
    testing_checkpoint: str = "data/emospeech.ckpt" #"data/deepvk_large_checkpoint/epoch=1079-step=127440.ckpt"
    audio_save_path: str = "data/deepvk_test" # directory where synthesised wav files will be saved
    nisqa_save_path: str = "data/deepvk_test" # directory where nisqa output files will be saved
    ...
    phones_path: str = "data/phones.json" # path to phones dictionary
